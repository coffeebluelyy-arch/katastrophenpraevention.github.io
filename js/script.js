...
const regionalePopupOverlay = document.getElementById('regionalePopupOverlay');
const regionalePopupTrigger = document.getElementById('regionalePopupTrigger');
const regionalePopupToast = document.getElementById('regionalePopupToast');
const regionaleInfoImage = document.getElementById('regionaleInfoImage');

if (regionalePopupOverlay && regionalePopupTrigger && regionalePopupToast && regionaleInfoImage) {
    regionalePopupTrigger.addEventListener('click', () => {
        regionalePopupToast.classList.add('is-visible');

        window.setTimeout(() => {
            regionalePopupToast.classList.remove('is-visible');
            regionalePopupOverlay.classList.remove('is-visible');
            regionaleInfoImage.src = '../../images/information_ready.png';
        }, 3000);
    }, { once: true });
}